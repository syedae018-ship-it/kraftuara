...
const navigationSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: "Creative Hub", href: "/dashboard/creative", icon: Sparkles, feature: "creative_discounts", badge: "AI" },
      { title: "Orders", href: "/dashboard/orders", icon: ShoppingBag, feature: "orders", badge: "12", requiredPlan: "Business" },
